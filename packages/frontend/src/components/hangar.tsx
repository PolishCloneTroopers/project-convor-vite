        ...
        <>
            ...
            <div id="links">
                <div id="social" className="flex flex-row align-middle mx-[15vw] lg:mx-[25vw] lg:mt-[2.5vh]">
                    {[{src:FacebookIcon,alt:"Facebook",href:"https://facebook.com/polishclonetroopers",},{src:InstagramIcon,alt:"Instagram",href:"https://instagram.com/polishclonetroopers",},{src:DiscordIcon,alt:"Discord",href:"https://discord.com/invite/WS56DPexDK",},].map(function(object){
                        return (
                ...
                <div id="navigation" className="lg:flex lg:flex-row align-middle lg:mx-[10vw] pt-[5vh]">
                    {[{to:"/about",text:"Kim jesteśmy?"}, {to:"https://discord.com/invite/WS56DPexDK",text:"Dołącz do nas!"}, {to:"/members",text:"Nasi żołnierze"}].map(function(object){
                        return (
